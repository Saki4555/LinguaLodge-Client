...
const StudentSideBar = () => {
    return (
            ...
            <>
                ...
                <li className="font-medium text-lg tracking-wider side-text"><NavLink to="/dashboard/enrolled" className={({ isActive }) => (isActive ? 'text-white' : '')}><FaStripe className="border border-teal-200 w-10"></FaStripe> My Enrolled Classes</NavLink></li>
